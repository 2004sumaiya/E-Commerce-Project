...
// Function to render beauty on beauty.html
function displayBeauty() {
    const beautyContainer = document.querySelector('#item-container');
  ...
  document.addEventListener('DOMContentLoaded', displayBeauty);
